...
Every real bug found so far fell into one of **twenty-three shapes**. Probe for these after any change. The list earns its keep: three of the last five bugs were found by walking it deliberately rather than by a test failing.

---

## The twenty-three shapes
